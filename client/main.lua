...
RegisterNetEvent('PSRCore:Client:OnPlayerLoaded')
AddEventHandler('PSRCore:Client:OnPlayerLoaded', function()
	PSRCore.Functions.GetPlayerData()
	isLoggedIn = true
end)

RegisterNetEvent('PSRCore:Client:OnPlayerUnload')
AddEventHandler('PSRCore:Client:OnPlayerUnload', function()
	isLoggedIn = false
	PlayerData = {}
end)

RegisterNetEvent('PSRCore:Client:OnJobUpdate')
AddEventHandler('PSRCore:Client:OnJobUpdate', function(JobInfo)
	PlayerData.job = JobInfo
end)

RegisterNetEvent('PSRCore:Client:SetPlayerData')
AddEventHandler('PSRCore:Client:SetPlayerData', function(val)
	PlayerData = val
end)
